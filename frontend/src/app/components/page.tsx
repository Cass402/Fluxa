...
export default function ComponentsPage() {
  ...
  const sampleTokens = [
    { symbol: 'SOL', name: 'Solana', address: 'sol-address', logo: 'https://cryptologos.cc/logos/solana-sol-logo.png' },
    { symbol: 'ETH', name: 'Ethereum', address: 'eth-address', logo: 'https://cryptologos.cc/logos/ethereum-eth-logo.png' },
    { symbol: 'USDC', name: 'USD Coin', address: 'usdc-address', logo: 'https://cryptologos.cc/logos/usd-coin-usdc-logo.png' },
    { symbol: 'BTC', name: 'Bitcoin', address: 'btc-address', logo: 'https://cryptologos.cc/logos/bitcoin-btc-logo.png' },
  ];
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <section className="mb-12">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Card>
            ...
            <CardContent>
              <p>Cards can contain any content, including text, images, and other components.</p>
            </CardContent>
            <CardFooter>
          ...
          <Card variant="elevated" padding="lg">
            <CardHeader>
              ...
              <CardDescription>A card with elevation and larger padding</CardDescription>
            </CardHeader>
            <CardContent>
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-semibold mb-4">Token Pair Selector Component</h2>
